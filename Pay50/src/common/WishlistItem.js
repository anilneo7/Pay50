...
const WishlistItem = ({ item, onRemoveItemFromWishlist, onAddWishlist }) => {
    return (
        <View style={styles.card}>
            ...
            <View style={styles.details}>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity style={styles.cartButton} activeOpacity={0.8} onPress={() => { onRemoveItemFromWishlist() }}>
